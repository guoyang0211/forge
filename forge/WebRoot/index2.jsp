...
<header id="pc-header">
	<div class="pc-header-nav">
		<div class="pc-header-con">
			<div class="fl pc-header-link" >您好:${sessionScope.loginName }，欢迎来云购物 <a href="login.jsp" target="_blank"></a> <a href="login.jsp" target="_blank"> 免费注册</a></div>
			<div class="fr pc-header-list top-nav">
				<ul>
					...
					<li><a href="#">帮助中心</a></li>
					<li><a href="#">退出</a></li>
					<li><a href="forgeServlet?method=exit&id=${sessionScope.forgeUser.userId}"><input type="submit" value="退出"></input></a></li>
				</ul>
			</div>
		</div>
	</div>
