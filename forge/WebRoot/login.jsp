                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="registered-customers">
                                ...
                                <form action="forgeServlet?method=login" id="login" method="post">
                                    <div class="login-account p-30 box-shadow">
                                        <p>If you have an account with us, Please log in.</p>
                                        <input type="text" placeholder="请输入登录名" name="loginName">
                                        <input type="password" placeholder="请输入密码" name="password">
                                        <p><small><a href="#">Forgot our password?</a></small></p>
                                        <p><input type="checkbox" name="remember" id="remember" >Remember the loginName</p>
										<div id="demo" ><!-- 隐藏滑块 -->
										  ...
										  <script>
										    $(function () {
										        var slider = new SliderUnlock("#slider",{
														...
														//alert("验证成功,即将跳转至主页面");
										            	//window.location.href="/forge/index.jsp"
                        ...
                        <div class="col-md-6">
                            <div class="registered-customers new-customers">
                                ...
                                <form action="forgeServlet?method=add" id="register" method="post">
                                    <div class="login-account p-30 box-shadow">
                                        <div class="row">
                                            <div class="col-sm-6">
...
<!--                                             <div class="col-sm-6"> -->
<!--                                                 <input type="text" placeholder="请输入名" name="lastName"> -->
<!--                                             </div> -->
                                        ...
                                        <input type="text" placeholder="请输入喜欢的编号"   name="id">
                                        ...
                                        <div class="checkbox">
                                            <label class="mr-10"> 
                                                <small>
                                                    <input type="checkbox" name="signup">注册我们的通讯!
                                                </small>
                                            </label>
                                            <label> 
                                                <small>
                                                    <input type="checkbox" name="signup">收到我们合作伙伴的特别优惠!
                                                </small>
                                            </label>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                               ...
                                               <input value="按钮"  type="submit" class="cart-button text-uppercase mt-20">
                                                <!-- <button value="register" type="submit" class="cart-button text-uppercase mt-20">注册</button> -->
                                            </div>
                                            <div class="col-md-6">
                                                <button type="reset" class="cart-button text-uppercase mt-20">清除</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>                                
