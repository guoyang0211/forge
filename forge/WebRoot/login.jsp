					...
					<div class="row">
						<div class="col-md-6">
							<div class="registered-customers">
								...
								<form action="forgeServlet?method=login" id="login"
									method="post">
									<div class="login-account p-30 box-shadow">
										...
										<p>
											<small><a href="#">忘记了密码?</a> </small>
										</p>
										<p>
											<input type="checkbox" name="remember" id="remember">记住登录名
										</p>
										<div id="demo">
											<!-- 隐藏滑块 -->
											...
											<input type="hidden" id="slider_block" value="0"
												name="slider_block" />
									...
									<div class="login-account p-30 box-shadow">
										...
										<div class="checkbox">
											<label class="mr-10"> <small> <input
												...
												<small> <input type="checkbox" name="signup">收到我们合作伙伴的特别优惠!
											</small> </label>
										</div>
										<div class="row">
											<div class="col-md-6">
												...
												<input value="注册" type="submit"
													class="cart-button text-uppercase mt-20">
												<!-- <button value="register" type="submit" class="cart-button text-uppercase mt-20">注册</button> -->
											</div>
											<div class="col-md-6">
												<button type="reset"
													class="cart-button text-uppercase mt-20">清除</button>
											</div>
										</div>
									</div>
								</form>
