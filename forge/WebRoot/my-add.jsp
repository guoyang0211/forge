	...
	<header id="pc-header">
		...
		<div class="pc-header-logo clearfix">
			...
			<div class="fr pc-head-car">
				<i class="icon-car"></i> <a href="my-car.jsp">我的购物车</a>
			</div>
		</div>
		<!--  顶部    start-->
		<div class="yHeader">
								...
								<div class="pay-info">
									...
									<ul class="pay-dz">
										<li class="current">
											<dl class="item" >
										<dd>
											<p>	<strong class="itemConsignee">收货人： &nbsp;&nbsp;&nbsp;${sessionScope.forgeUser.getLoginName()}</strong></p>
											<p class="tel itemTel"><strong>手机号： &nbsp;&nbsp;&nbsp;${sessionScope.forgeUser.phone}</strong></p>
											<p class="itemRegion"><strong>地 址： &nbsp;&nbsp;&nbsp;${sessionScope.forgeUser.address}</strong></p>
...
<!-- 										<li> -->
<!-- 											<h3> -->
<!-- 												<span class="sp1">南赡部洲</span><span class="sp2">东土大唐</span>（<spanclass="sp3">佩奇</span> 收） -->
<!-- 											</h3> -->
<!-- 											 <a href="JavaScript:;" xiugai="">修改</a> -->
<!-- 										</li> -->
										<div style="clear:both;"></div>
									</ul>
									<P class="pay-xgdz" style="color:red">修改请点击使用新地址</P>
