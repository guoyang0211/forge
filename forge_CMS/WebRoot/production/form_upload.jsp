						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<form id="demo-form2" data-parsley-validate
									...
									action="/forge_CMS/NewsServlet?method=method"
									method="post"
																...
																<div class="controls">
																	<div
																		...
																		<input type="text"
																			...
																			aria-describedby="inputSuccess2Status" name="createTime"> <span
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="x_panel">
											...
											<div class="x_content">
												...
												<div name="content" id="editor-one" class="editor-wrapper" ></div>
												<!--  <textarea id="descr" style="display:block;" ></textarea>-->
												<br />
												...
												<div class="form-group">
													...
													<div class="col-md-9 col-sm-9 col-xs-12">
														<textarea name="content" class="resizable_textarea form-control"
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<p>Drag multiple files to the box below for multi upload or
									  ...
									  <form action="/forge_CMS/NewsServlet?method=method2"   class="dropzone" enctype="multipart/form-data" method="post"></form>
									<br /> <br /> <br /> <br />
