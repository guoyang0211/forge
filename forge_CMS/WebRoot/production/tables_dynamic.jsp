                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <c:forEach items="${sessionScope.userList}" var="users">
	                      <tr>
	                          ...
	                          <a href="/forge_CMS/UserServlet?method=findById&id=${users.userId}" class="btn btn-success" >修改用户</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                          <a  type="button" class="btn btn-primary" href="javascript:del('/forge_CMS/UserServlet?method=delete&id=${users.userId}')">删除用户</a></td>
